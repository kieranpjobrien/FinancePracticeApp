      ...
      <div className="flex items-center justify-between px-6 py-4 border-b border-white/5">
        <div>
          ...
          <div className="text-xs text-slate-500 mt-0.5">
            {question.topic} &rsaquo; {question.subtopic}
          </div>
        </div>
      ...
      <div className="px-6 pb-4 space-y-2.5">
        {Object.entries(question.options).map(([key, text]) => {
          ...
          if (result) {
            ...
            classes = 'bg-indigo-500/15 border-indigo-500/40 ring-1 ring-indigo-500/20';
          }
      ...
      <div className="px-6 py-4 border-t border-white/5 flex items-center justify-between">
        ...
        {!result ? (
          <button
            ...
            className="px-6 py-2.5 bg-gradient-to-r from-indigo-500 to-purple-600 text-white font-medium rounded-xl hover:from-indigo-400 hover:to-purple-500 transition-all disabled:opacity-30 disabled:cursor-not-allowed"
          >
          ...
          <button
            onClick={onNext}
            className="px-6 py-2.5 bg-gradient-to-r from-indigo-500 to-purple-600 text-white font-medium rounded-xl hover:from-indigo-400 hover:to-purple-500 transition-all"
          >
