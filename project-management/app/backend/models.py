"""Data models for PMP Practice App."""
...
class Question(BaseModel):
    ...
    type: Literal["conceptual", "situational", "technical", "calculation"] = "situational"
    question: str
...
class SessionConfig(BaseModel):
    ...
    session_type: Literal["domain_drill", "mixed", "weak_areas", "mock_exam"] = "mixed"
...
class SessionSummary(BaseModel):
    ...
    domains: list[str]
    results_by_domain: dict[str, dict]  # {"domain": {"correct": n, "total": n, "percent": float}}
    error_summary: dict[str, int]  # {"conceptual": n, "situational": n, ...}
