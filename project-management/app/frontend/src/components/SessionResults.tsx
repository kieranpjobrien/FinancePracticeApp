    ...
    <div className="glass max-w-2xl mx-auto animate-slide-up overflow-hidden">
      ...
      <div className="p-6">
        <button
          ...
          className="w-full py-3.5 px-6 bg-gradient-to-r from-teal-500 to-emerald-600 text-white font-semibold rounded-xl hover:from-teal-400 hover:to-emerald-500 transition-all"
        >
          New Session
        </button>
      </div>
