...
export function ProgressDashboard({ onClose }: Props) {
  ...
  const domains = Object.entries(progress.by_domain).sort((a, b) =>
  ...
  return (
    <div className="glass p-6 animate-slide-up">
      ...
      {/* Overall Stats */}
      <div className="mb-8 p-5 rounded-xl bg-gradient-to-br from-teal-500/10 to-emerald-500/10 border border-teal-500/10">
        ...
        {progress.overall.times_shown === 0 ? (
          ...
          <div className="grid grid-cols-3 gap-4 text-center">
            <div>
              <div className="text-3xl font-bold bg-gradient-to-r from-teal-400 to-emerald-400 bg-clip-text text-transparent tabular-nums">
      ...
      <div className="mb-8">
        ...
        <div className="space-y-3">
          {domains.map(([domain, data]) => (
            <div key={domain} className="p-4 rounded-xl bg-white/[0.03] border border-white/5">
