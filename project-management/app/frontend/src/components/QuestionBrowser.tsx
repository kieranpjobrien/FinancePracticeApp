    ...
    return (
      <div className="glass p-6 animate-fade-in">
        <button
          ...
          className="mb-5 text-sm text-teal-400 hover:text-teal-300 transition-colors flex items-center gap-1"
        >
        ...
        <div className="mb-4 flex items-center gap-2">
          ...
          <span className="text-sm text-slate-500">
            {selectedQuestion.domain} &rsaquo; {selectedQuestion.task}
          </span>
        </div>
        ...
        <div className="rounded-xl bg-teal-500/10 border border-teal-500/15 p-5">
    ...
    <div className="glass p-6 animate-slide-up">
      ...
      <div className="flex gap-3 mb-6 flex-wrap items-center">
        <select
          ...
          className="px-3.5 py-2 rounded-xl bg-white/5 border border-white/5 text-sm text-slate-300 focus:outline-none focus:ring-1 focus:ring-teal-500/40 appearance-none cursor-pointer"
        >
        ...
        <table className="min-w-full text-sm">
          <thead>
            <tr className="border-b border-white/5">
              ...
              <th className="text-left py-3 px-4 text-xs font-semibold uppercase tracking-wider text-slate-500">Domain</th>
              <th className="text-left py-3 px-4 text-xs font-semibold uppercase tracking-wider text-slate-500">Task</th>
          ...
          <tbody>
            {filteredQuestions.map(q => (
              ...
              >
                ...
                <td className="py-3 px-4 text-slate-300">{q.domain}</td>
                <td className="py-3 px-4 text-slate-400 text-xs">{q.task}</td>
